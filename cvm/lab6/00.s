	...
	.file	1 "/Users/ivan/prog/sem3/cvm/lab6" "00.c"
...
## %bb.2:                               ##   in Loop: Header=BB0_1 Depth=1
	...
	mov	eax, dword ptr [ebp - 16]       ## 4-byte Reload
Ltmp3:
	.loc	1 9 16 is_stmt 1                ## 00.c:9:16
	mov	eax, dword ptr [eax + L_i$non_lazy_ptr-L0$pb]
	cmp	dword ptr [eax], 3
	.loc	1 9 21 is_stmt 0                ## 00.c:9:21
	jbe	LBB0_5
## %bb.3:                               ##   in Loop: Header=BB0_1 Depth=1
	.loc	1 0 21                          ## 00.c:0:21
	mov	eax, dword ptr [ebp - 16]       ## 4-byte Reload
	.loc	1 9 27                          ## 00.c:9:27
	mov	eax, dword ptr [eax + L_i$non_lazy_ptr-L0$pb]
	cmp	dword ptr [eax], 6
Ltmp4:
	.loc	1 9 13                          ## 00.c:9:13
	je	LBB0_5
## %bb.4:                               ##   in Loop: Header=BB0_1 Depth=1
	.loc	1 0 13                          ## 00.c:0:13
	mov	esi, dword ptr [ebp - 16]       ## 4-byte Reload
Ltmp5:
	.loc	1 10 28 is_stmt 1               ## 00.c:10:28
	mov	eax, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	edx, dword ptr [eax]
	.loc	1 10 26 is_stmt 0               ## 00.c:10:26
	mov	eax, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	shl	edx, 3
	.loc	1 10 31                         ## 00.c:10:31
	or	edx, 3
	.loc	1 10 18                         ## 00.c:10:18
	mov	eax, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	ecx, dword ptr [eax]
	.loc	1 10 21                         ## 00.c:10:21
	mov	eax, dword ptr [esi + L_cMas$non_lazy_ptr-L0$pb]
	mov	esi, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	dword ptr [eax + 4*ecx], edx
	.loc	1 10 13                         ## 00.c:10:13
	jmp	LBB0_6
LBB0_5:                                 ##   in Loop: Header=BB0_1 Depth=1
	.loc	1 0 13                          ## 00.c:0:13
	mov	esi, dword ptr [ebp - 16]       ## 4-byte Reload
	.loc	1 12 31 is_stmt 1               ## 00.c:12:31
	mov	eax, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	imul	eax, dword ptr [eax], 25
	.loc	1 12 35 is_stmt 0               ## 00.c:12:35
	mov	ecx, 3
	xor	edx, edx
	div	ecx
	mov	edx, eax
	.loc	1 12 18                         ## 00.c:12:18
	mov	eax, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	ecx, dword ptr [eax]
	.loc	1 12 21                         ## 00.c:12:21
	mov	eax, dword ptr [esi + L_cMas$non_lazy_ptr-L0$pb]
	mov	esi, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	dword ptr [eax + 4*ecx], edx
Ltmp6:
LBB0_6:                                 ##   in Loop: Header=BB0_1 Depth=1
	.loc	1 13 5 is_stmt 1                ## 00.c:13:5
	jmp	LBB0_7
Ltmp7:
LBB0_7:                                 ##   in Loop: Header=BB0_1 Depth=1
	.loc	1 0 5 is_stmt 0                 ## 00.c:0:5
	mov	eax, dword ptr [ebp - 16]       ## 4-byte Reload
	.loc	1 8 25 is_stmt 1                ## 00.c:8:25
...
LBB0_8:
	...
	mov	eax, dword ptr [ebp - 16]       ## 4-byte Reload
Ltmp9:
	.loc	1 15 12 is_stmt 1               ## 00.c:15:12
	mov	eax, dword ptr [eax + L_i$non_lazy_ptr-L0$pb]
	mov	dword ptr [eax], 0
LBB0_9:                                 ## =>This Inner Loop Header: Depth=1
	...
	mov	eax, dword ptr [ebp - 16]       ## 4-byte Reload
Ltmp10:
	.loc	1 15 19                         ## 00.c:15:19
	mov	eax, dword ptr [eax + L_i$non_lazy_ptr-L0$pb]
	cmp	dword ptr [eax], 9
Ltmp11:
	.loc	1 15 5                          ## 00.c:15:5
	jae	LBB0_12
## %bb.10:                              ##   in Loop: Header=BB0_9 Depth=1
	.loc	1 0 5                           ## 00.c:0:5
	mov	esi, dword ptr [ebp - 16]       ## 4-byte Reload
Ltmp12:
	.loc	1 16 35 is_stmt 1               ## 00.c:16:35
	mov	eax, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	ecx, dword ptr [eax]
	.loc	1 16 43 is_stmt 0               ## 00.c:16:43
	mov	eax, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	edx, dword ptr [eax]
	.loc	1 16 38                         ## 00.c:16:38
	mov	eax, dword ptr [esi + L_cMas$non_lazy_ptr-L0$pb]
	mov	edi, dword ptr [esi + L_i$non_lazy_ptr-L0$pb]
	mov	eax, dword ptr [eax + 4*edx]
	.loc	1 16 9                          ## 00.c:16:9
...
## %bb.11:                              ##   in Loop: Header=BB0_9 Depth=1
	.loc	1 0 9                           ## 00.c:0:9
	mov	eax, dword ptr [ebp - 16]       ## 4-byte Reload
	.loc	1 15 25 is_stmt 1               ## 00.c:15:25
	mov	ecx, dword ptr [eax + L_i$non_lazy_ptr-L0$pb]
	mov	ecx, dword ptr [ecx]
	mov	edx, dword ptr [eax + L_i$non_lazy_ptr-L0$pb]
	add	ecx, 1
	mov	eax, dword ptr [eax + L_i$non_lazy_ptr-L0$pb]
	mov	dword ptr [eax], ecx
	.loc	1 15 5 is_stmt 0                ## 00.c:15:5
	jmp	LBB0_9
Ltmp13:
LBB0_12:
	.loc	1 18 5 is_stmt 1                ## 00.c:18:5
	xor	eax, eax
	.loc	1 18 5 epilogue_begin is_stmt 0 ## 00.c:18:5
	add	esp, 32
	pop	esi
	pop	edi
	pop	ebp
...
.set Lset1, Lsection_abbrev-Lsection_abbrev ## Offset Into Abbrev. Section
	...
	.byte	1                               ## Abbrev [1] 0xb:0x9c DW_TAG_compile_unit
...
.set Lset3, Lfunc_end0-Lfunc_begin0     ## DW_AT_high_pc
	...
	.byte	4                               ## DW_AT_byte_size
	.byte	8                               ## Abbrev [8] 0x91:0x15 DW_TAG_subprogram
	.long	Lfunc_begin0                    ## DW_AT_low_pc
