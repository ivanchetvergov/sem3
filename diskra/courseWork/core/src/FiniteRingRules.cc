...
char FiniteRing::add(char a, char b) const {
...
char FiniteRing::subtract(char a, char b) const {
...
char FiniteRing::multiply(char a, char b) const {
    return rules_.getValueChar(
...
char FiniteRing::divide(char a, char b) const {
...
char FiniteRing::findMultiplicativeInverse(char element) const {
